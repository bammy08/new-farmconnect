  ...
  return (
    <Card className="bg-slate-50 dark:bg-slate-700 dark:border-slate-600">
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 font-medium leading-none text-slate-800 dark:text-slate-50">
          Trending up by 5.2% this month{' '}
          <TrendingUp className="h-4 w-4 text-slate-800 dark:text-slate-50" />
        </div>
        <div className="leading-none text-muted-foreground text-slate-800 dark:text-slate-50">
